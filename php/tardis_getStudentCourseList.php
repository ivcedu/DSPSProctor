<?php
    ...
    $query = "SELECT crif.InstructorName, crif.InstructorUID, crif.CourseID, crif.SectionNum, crif.CourseTitle "
            . "FROM [SKYBLAST.SOCCCD.EDU].[Tardis].[dbo].[StudentCourses] AS stcr "
            . "LEFT JOIN [SKYBLAST.SOCCCD.EDU].[Tardis].[dbo].[CourseInfo] AS crif ON stcr.SectionNum = crif.SectionNum AND stcr.TermCode = crif.TermCode "
