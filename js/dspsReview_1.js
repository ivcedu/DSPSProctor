...
$(document).ready(function() { 
    ...
    $('#mod_deny_btn_yes').click(function() { 
        ...
        if (db_insertProctorLog(proctor_id, textReplaceApostrophe(sessionStorage.getItem('ls_dsps_proctor_loginDisplayName')), 1, 3) === "") {
    ...
    $('#btn_cancel').click(function() { 
        ...
        if (db_insertProctorLog(proctor_id, textReplaceApostrophe(sessionStorage.getItem('ls_dsps_proctor_loginDisplayName')), 1, 10) === "") {
